...
此外，一些厂商公开的API服务通常也会限制用户的请求次数，比如百度地图开放平台等会根据用户的付费情况来限制用户的请求数等。![百度地图开放平台API调用策略](C:\Users\wxz18\VsCode\学习日记\2 菜鸟教程系列\菜鸟_Go学习\D14常用限流策略——漏桶与令牌桶介绍.assets\baidumap_ratelimit.jpg)
...
![漏桶算法原理](C:\Users\wxz18\VsCode\学习日记\2 菜鸟教程系列\菜鸟_Go学习\D14常用限流策略——漏桶与令牌桶介绍.assets\loutong.jpg)
...
![令牌桶原理](C:\Users\wxz18\VsCode\学习日记\2 菜鸟教程系列\菜鸟_Go学习\D14常用限流策略——漏桶与令牌桶介绍.assets\lingpaitong.jpg)
