...
举个例子，现在有一个数组`a := [8]int{0, 1, 2, 3, 4, 5, 6, 7}`，切片`s1 := a[:5]`，相应示意图如下。![slice_01](C:\Users\wxz18\VsCode\学习日记\2 菜鸟教程系列\菜鸟_Go学习\A10Go语言基础之切片.assets\slice_01.png)切片`s2 := a[3:6]`，相应示意图如下：![slice_02](C:\Users\wxz18\VsCode\学习日记\2 菜鸟教程系列\菜鸟_Go学习\A10Go语言基础之切片.assets\slice_02.png)
